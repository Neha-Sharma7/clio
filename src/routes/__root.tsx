  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <h1 className="mt-3 font-display text-5xl font-medium text-foreground">Not found</h1>
        <p className="mt-3 text-sm text-muted-foreground">
          This page has been moved, renamed, or never existed.
        </p>
        <Link
          to="/"
...
function ErrorComponent({ error, reset }: { error: Error; reset: () => void }) {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        <h1 className="font-display text-2xl font-medium">Something broke</h1>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Clio is the memory layer for organizations. Capture meetings, extract decisions and action items, and give your team continuity across every conversation." },
      { property: "og:title", content: "Clio — Meeting intelligence for teams that ship" },
      { property: "og:description", content: "The AI memory layer for organizations." },
